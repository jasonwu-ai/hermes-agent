...
Accept only one task-bound Test package and named workspace. Independently verify the frozen candidate with task-specified checks and produce evidence without altering source or candidate identity.
